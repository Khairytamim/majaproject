...
<div class="row">
    <form class="col s12">
      ...
      <div class="input-field col s12">
        ...
        <a id="pesan" href="#modal1" class="modal-trigger waves-effect waves-light btn" style="margin-top:20px; margin-bottom:20px;">PESAN</a>  
      </div>
      <div class="input-field col s12">
 	<div class="row">		 
  ...
  <div id="modal1" class="modal modal-fixed-footer">
    <div class="modal-content">
     <div class="row">
      <div class="col s12">
           <h4>CART</h4>
           <p>1 item telah ditambahkan ke cart anda</p>
      </div>
     </div>
     <div class="row">
          <div class="col s12 m4">
               <div class="card">
                    <div class="card-image"> <img style="width:100%" src='<?php echo base_url();?>assets/gambar_kaos/small/1/<?php echo $row->id_produk;?>.jpg' onerror="this.src='<?php echo base_url();?>assets/gambar_pohon/pohon_1.png'"> 
                        
                    </div>
                    <div class="card-content">
                         <p align="left"><?php echo $row->nama_produk;?></p>
                    </div>
               </div>
          </div>
    ...
    <div class="modal-footer">
      <a href="#!" class=" modal-action modal-close waves-effect waves-green btn-flat">Lanjutkan Belanja</a>
      <a href="<?php echo base_url();?>cart" class=" modal-action modal-close waves-effect waves-green btn">Konfirmasi Pemesanan</a>
    </div>
  </div>
