				 ...
				 <div class="nav-wrapper" style="line-height:3.4em">
					...
					<a href="<?php echo base_url();?>home" class="brand-logo"><img src="<?php echo base_url();?>assets/img/logo_seve/logo2-01.png" style="margin-top:0.1em; width:60px"></a>         
						...
						<ul class="right hide-on-med-and-down">
							...
							<li><a class="modal-trigger" href="#loginmodal" style="font-size:0.9em; ">LOGIN</a></li><?php } ?>

							<?php if($this->session->userdata('nama_user') == null){ ?><li><a class="modal-trigger" href="#signupmodal" style="font-size:0.9em; ">DAFTAR</a></li><?php } ?>
							
							<?php if($this->session->userdata('nama_user') != null){ ?>
							<li><a class="dropdown-button" href="#" data-activates="userdropdown" style="font-size:0.9em; "><img src="<?php echo base_url();?>assets/img/userwhite.png" style="height: 1em; color:rgba(0,0,0,0.87)"> <?php echo $this->session->userdata('nama_user');?></a></li><?php } ?>
							...
							<ul id="userdropdown" class="dropdown-content">
							    ...
							    <li><a href="<?php echo base_url();?>home/logout" style="color: rgba(0,0,0,0.87); font-size: 0.9em; ">Logout</a></li>
							</ul>
						</ul> 
...
<li><a href="<?php echo base_url();?>cart" style="font-size:0.9em; ">CART</a></li>
							<?php if($this->session->userdata('nama_user') == null){ ?>
							<li><a class="modal-trigger" href="#loginmodal" style="font-size:0.9em; ">LOGIN</a></li><?php } ?>

							<?php if($this->session->userdata('nama_user') == null){ ?><li><a class="modal-trigger" href="#signupmodal" style="font-size:0.9em; ">SIGN UP</a></li><?php } ?>
							
							<?php if($this->session->userdata('nama_user') != null){ ?>
							<li><a class="dropdown-button" href="#" style="font-size:0.9em; "><?php echo $this->session->userdata('nama_user');?></a></li><?php } ?>
<li><a href="<?php echo base_url();?>home/logout" style="color: rgba(0,0,0,0.87); font-size: 0.9em; ">LOG OUT</a></li>
						      <li class="no-padding">
