  <footer>
  	...
  	<div class= "row" style="margin-bottom: 0; padding-top:2em;">
  	   <div class="container">
  	   	<div style="border-top: solid 0.3em #e393b0; width:100%; margin-bottom:2em"></div>
	  	<div class="col s6 l3" style="min-height:10em;">
	  		<div style="display:block; color: #e393b0"><b>SEVE</b></div>
	  	...
	  	<div class="col s6 l3" style=" min-height:10em">
	  		<div style="display:block; color: #e393b0"><b>HELP</b></div>
	  	...
	  	<div class="col s6 l3" style="min-height:10em">
	  		<div style="display:block; color: #e393b0" class="truncate"><b>PAYMENT & DELIVERY</b></div>
	  	...
	  	<div class="col s6 l3" style=" min-height:10em">
	  		<div style="display:block; color: #e393b0"><b>SOCIAL MEDIA</b></div>
  	...
  	<div class="row" style="margin-bottom: 0;">
	  	<div class="col s12 l12" style="background-color: #E91D63; padding:0.5em 0; color: white; border-bottom: solid 0.3em #e393b0">
		      <center>
